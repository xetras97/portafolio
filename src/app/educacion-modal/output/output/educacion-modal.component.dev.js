...
function () {
  ...
  EducacionModalComponent.prototype.setDefaultForm = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        return [2
        /*return*/
        , this.setForm(this.dataForm[id].titulo, this.dataForm[id].año, this.dataForm[id].institucion, this.dataForm[id].periodo)];
      });
    });
  };
  ...
  EducacionModalComponent = __decorate([core_1.Component({
